				...
				<table class="table w-full">
					...
					<tbody>
						...
						<tr>
							<th>학점</th>
							<td>
							   <select class="select select-ghost w-32 max-w-xs ml-2" id="credit" name="credit" onchange="handleSubmit()">
						...
						<tr>
							<th>평점</th>
							<td>
							   <select class="select select-ghost w-32 max-w-xs ml-2" id="grade" name="grade" onchange="handleSubmit2()">
