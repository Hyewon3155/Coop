    ...
    <div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
		...
		<form action="doWorkCreate"  method="POST" onsubmit="submitForm(this); return false;">
           ...
           <input type="hidden" name="project_id" value="${project_id}">
            ...
            <input type="text" name="title" class="w-full p-2 mb-4 border rounded" placeholder="작업명을 입력해주세요">

            <!-- 템플릿 선택 -->
            <label for="templateChoice" class="block mb-2 text-base font-bold">작업 설명</label>
            <input type="text" name="body" class="w-full p-2 mb-4 border rounded" placeholder="작업 설명을 입력해주세요">
