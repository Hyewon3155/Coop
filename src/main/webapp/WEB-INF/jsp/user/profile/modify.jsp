	            ...
	            <label for="file" class="flex text-center p-1 cursor-pointer">
	                ...
	                <input type="file" id="file" name="photo" class="hidden" accept="image/*" onchange="previewImage(event)">
						...
						<tr>
 						...
 						<tr>
							<th>학교</th>
							<td><input class="input input-bordered w-20 ml-2" type="text" name="school" value="${profile.school }"/> 대학교 <input class="input input-bordered w-32 ml-2" type="text" name="depart" value="${profile.depart }"/> 과</td>
						</tr>
						<tr>
							<th>전화번호</th>
							<td><input class="input input-bordered w-24 ml-2" type="text" name="phone1" value="${phone1 }"/>-<input class="input input-bordered w-24" type="text" name="phone2" value="${phone2 }"/>-<input class="input input-bordered w-24" type="text" name="phone3" value="${phone3 }"/></td>
						</tr>
						<tr>
							<th>메일</th>
							<td><input class="input input-bordered w-2/6 ml-2" type="email" name="email" placeholder="메일을 입력해주세요" value="${profile.email }"/></td>
						</tr>
					</tbody>
				</table>
				</div>
